...
//Stripinvader2 stuff
#define OSC_MSG_HELLO "/hello"
#define OSC_MSG_CONFIG_SEND "/sendConfig"
#define OSC_MSG_SET_RGB "/hello"
...
// no point in carrying on, so do nothing forevermore:
  ...
  oscServer.addCallback(OSC_MSG_CONFIG_SEND, &oscCallbackConfigSend);
  oscServer.addCallback(OSC_MSG_HELLO, &oscCallbackHello);
  oscServer.addCallback(OSC_MSG_SET_RGB, &oscCallbacksetRGB);
